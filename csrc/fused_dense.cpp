...
at::Tensor linear_bias_forward(at::Tensor input, at::Tensor weight,
                               at::Tensor bias) {
  ...
  // auto reserved_size = get_mlp_reserved_space(batch_size, num_layers,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      "linear_bias_forward", [&] {
        ...
        auto result = linear_bias_forward_cuda<scalar_t>(
            input, w_ptr, bias, in_features, batch_size, out_features, out,
...
linear_bias_backward(at::Tensor input, at::Tensor weight, at::Tensor d_output) {
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      "linear_bias_backward", [&] {
        ...
        auto result = linear_bias_backward_cuda<scalar_t>(
            input.data_ptr<scalar_t>(), w_ptr, d_output.data_ptr<scalar_t>(),
            in_features, batch_size, out_features,
            d_weight.data_ptr<scalar_t>(), d_bias.data_ptr<scalar_t>(),
...
std::vector<at::Tensor> linear_gelu_linear_forward(at::Tensor input,
                                                   at::Tensor weight1,
                                                   at::Tensor bias1,
                                                   at::Tensor weight2,
                                                   at::Tensor bias2) {
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      "linear_gelu_linear_forward", [&] {
        ...
        auto result = linear_gelu_linear_forward_cuda<scalar_t>(
            input.data_ptr<scalar_t>(), w1_ptr, b1_ptr, w2_ptr, b2_ptr,
            in_features, hidden_features, batch_size, out_features,
            output1.data_ptr<scalar_t>(), output2.data_ptr<scalar_t>(),
...
std::vector<at::Tensor>
linear_gelu_linear_backward(at::Tensor input, at::Tensor gelu_in,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      "linear_bias_backward", [&] {
        ...
        auto result = linear_gelu_linear_backward_cuda<scalar_t>(
            input.data_ptr<scalar_t>(), gelu_in.data_ptr<scalar_t>(),
            output1.data_ptr<scalar_t>(), weight1.data_ptr<scalar_t>(),
            weight2.data_ptr<scalar_t>(), d_output1.data_ptr<scalar_t>(),
            d_output2.data_ptr<scalar_t>(), in_features, batch_size,
            hidden_features, out_features, d_weight1.data_ptr<scalar_t>(),
            d_weight2.data_ptr<scalar_t>(), d_bias1.data_ptr<scalar_t>(),
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("linear_bias_backward", &linear_bias_backward, "linear bias backward",
        py::call_guard<py::gil_scoped_release>());
  m.def("linear_gelu_linear_forward", &linear_gelu_linear_forward,
        "linear gelu linear forward", py::call_guard<py::gil_scoped_release>());
  m.def("linear_gelu_linear_backward", &linear_gelu_linear_backward,
