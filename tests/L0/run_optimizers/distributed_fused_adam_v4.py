...
class DistributedFusedAdam(torch.optim.Optimizer):
    ...
    def __launch_step_kernel(self):
        ...
        if torch.distributed.get_rank() == 0:
            print('dist m:', self._contrib_tensor_list[1])
            print('dist v:', self._contrib_tensor_list[2])
            print('dist p:', self._contrib_tensor_list[0])
            print('dist g:', self._contrib_tensor_list[3])
        multi_tensor_applier(distributed_adam_cuda.multi_tensor_fused_adam,
                ...
                self.eps_mode)
        if torch.distributed.get_rank() == 0:
            print('dist new m:', self._contrib_tensor_list[1])
            print('dist new v:', self._contrib_tensor_list[2])
            print('dist new p:', self._contrib_tensor_list[0])
            print('dist new g:', self._contrib_tensor_list[3])
            print('dist new p_copy:', self._contrib_tensor_list[4])
