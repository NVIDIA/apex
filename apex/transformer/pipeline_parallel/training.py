...
def pretrain(
    ...
    if args.do_test:
        ...
        evaluate_and_print_results(prefix, forward_step_func, test_data_iterator, model, 0, True)
...
def setup_model_and_optimizer(model_provider_func):
    ...
    unwrapped_model = unwrap_model(model, (DDP, LocalDDP, Float16Module))
...
def train(
    forward_step_func, model, optimizer, lr_scheduler, train_data_iterator, valid_data_iterator
):
