...
def additive_mask_softmax_dropout_forward(
    use_mask, is_training, heads, input, pad_mask, dropout_prob
):
...
def additive_mask_softmax_dropout_backward(
    use_mask, heads, output_grads, softmax_results, dropout_mask, dropout_prob
):
...
def mask_softmax_dropout_backward(
    use_mask, heads, output_grads, softmax_results, dropout_mask, padding_mask, dropout_prob
):
