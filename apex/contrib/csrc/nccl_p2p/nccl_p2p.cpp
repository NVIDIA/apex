...
void apex_nccl_p2p_left_right_halo_exchange_inplace(int64_t handle, int64_t left_rank, int64_t right_rank,
  ...
  apex::contrib::nccl_p2p::left_right_halo_exchange_inplace(
      static_cast<int>(handle), static_cast<int>(left_rank), static_cast<int>(right_rank), left_output_halo,
...
std::vector<at::Tensor> apex_nccl_p2p_left_right_halo_exchange(int64_t handle, int64_t left_rank, int64_t right_rank,
  ...
  return apex::contrib::nccl_p2p::left_right_halo_exchange(
      static_cast<int>(handle), static_cast<int>(left_rank), static_cast<int>(right_rank), left_output_halo,
      right_output_halo);
}
...
TORCH_LIBRARY_FRAGMENT(apex, m) {
  ...
  m.def("nccl_p2p_left_right_halo_exchange_inplace(int handle, int left_rank, int right_rank, "
        "Tensor left_output_halo, Tensor right_output_halo, Tensor(a!) left_input_halo, "
        "Tensor(b!) right_input_halo) -> ()");
  m.def("nccl_p2p_left_right_halo_exchange(int handle, int left_rank, int right_rank, Tensor left_output_halo, "
