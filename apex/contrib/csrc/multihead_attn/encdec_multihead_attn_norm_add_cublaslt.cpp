...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward_init", &multihead_attn::encdec_norm_add::cublaslt_matmul::fwd_init_cuda, "Multihead Attention Forward Init.");
  m.def("backward_init", &multihead_attn::encdec_norm_add::cublaslt_matmul::bwd_init_cuda, "Multihead Attention Backward Init.");
  m.def("forward_del", &multihead_attn::encdec_norm_add::cublaslt_matmul::fwd_del_cuda, "Multihead Attention Forward Del.");
  m.def("backward_del", &multihead_attn::encdec_norm_add::cublaslt_matmul::bwd_del_cuda, "Multihead Attention Backward Del.");
  m.def("forward", &multihead_attn::encdec_norm_add::cublaslt_matmul::fwd, "Encdec Multihead Attention Plus Layer Norm and Residual Add Forward.");
  m.def("backward", &multihead_attn::encdec_norm_add::cublaslt_matmul::bwd, "Encdec Multihead Attention Plus Layer Norm and Residual Add Backward.");
}
