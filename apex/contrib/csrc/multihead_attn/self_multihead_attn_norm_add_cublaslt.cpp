...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward_init", &multihead_attn::self_norm_add::cublaslt_matmul::fwd_init_cuda, "Multihead Attention Forward Init.");
  m.def("backward_init", &multihead_attn::self_norm_add::cublaslt_matmul::bwd_init_cuda, "Multihead Attention Backward Init.");
  m.def("forward_del", &multihead_attn::self_norm_add::cublaslt_matmul::fwd_del_cuda, "Multihead Attention Forward Del.");
  m.def("backward_del", &multihead_attn::self_norm_add::cublaslt_matmul::bwd_del_cuda, "Multihead Attention Backward Del.");
  m.def("forward", &multihead_attn::self_norm_add::cublaslt_matmul::fwd, "Self Multihead Attention Plus Layer Norm and Residual Add Forward.");
  m.def("backward", &multihead_attn::self_norm_add::cublaslt_matmul::bwd, "Self Multihead Attention Plus Layer Norm and Residual Add Backward.");
}
