...
void multi_tensor_lamb_compute_update_term_dispatch(int64_t chunk_size, at::Tensor noop_flag,
                                                    std::vector<std::vector<at::Tensor>> tensor_lists,
                                                    at::Tensor per_tensor_beta1, at::Tensor per_tensor_beta2,
                                                    at::Tensor per_tensor_beta3,
                                                    at::Tensor per_tensor_bias_correction, at::Tensor step,
                                                    at::Tensor per_tensor_epsilon, int64_t mode,
                                                    at::Tensor per_tensor_decay, at::Tensor global_scale,
...
void multi_tensor_lamb_update_weights_dispatch(int64_t chunk_size, at::Tensor noop_flag,
                                               std::vector<std::vector<at::Tensor>> tensor_lists,
                                               at::Tensor per_tensor_param_norm, at::Tensor per_tensor_update_norm,
                                               at::Tensor update_norm_offset, at::Tensor learning_rate,
                                               at::Tensor per_tensor_decay, at::Tensor global_grad_norm,
                                               bool use_nvlamb) {
...
TORCH_LIBRARY_IMPL(apex, CUDA, m) {
  m.impl("distributed_lamb_compute_update_term", &multi_tensor_lamb_compute_update_term_dispatch);
  m.impl("distributed_lamb_update_weights", &multi_tensor_lamb_update_weights_dispatch);
}
