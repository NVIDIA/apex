...
int run_check_permutations(
    ...
    py::array_t<unsigned int> &py_stripe_groups,  // groups of stripes, group_width = stripes per
                                                  // group, num_groups = groups in the array
    unsigned int group_width, unsigned int num_groups,
    py::array_t<unsigned int> &py_permutations,  // array of permutations to try, group_width*4
                                                 // values per each of num_permutations permutations
