...
def test_openfold_triton_mha(Z, H, N_CTX, D_HEAD, dtype=torch.float16):
    ...
    assert torch.allclose(ref_dbias, tri_dbias, atol=1e-2, rtol=0)


if __name__ == "__main__":
    # representative workload in openfold
    test_openfold_triton_mha(Z=256, H=4, N_CTX=256, D_HEAD=32, dtype=torch.bfloat16)
